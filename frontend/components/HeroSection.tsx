    ...
    <div className="my-20">
      <div className="flex flex-1 min-h-screen justify-center items-center">
        <div className="flex flex-col w-4/5 md:w-1/2 gap-5 justify-center items-center md:items-start mx-10 md:mx-20 py-4">
          <div className="text-3xl md:text-5xl font-bold text-wrap text-left group">
          ...
          <button className="text-2xl font-semibold px-4 py-2 rounded-2xl bg-black/80 border hover:bg-gradient-to-r hover:from-orange-400 hover:to-red-400 hover:border-red-600  active:scale-110 cursor-pointer transition-all duration-500">
            Start Chatting 🔥
          </button>
        </div>
