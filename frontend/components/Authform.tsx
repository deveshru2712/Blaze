...
//       <div className="bg-black/60 lg:min-w-[566px] px-8 py-6 border text-white/95 border-slate-100/30 shadow-lg rounded-lg">
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center px-6 text-white">
      <div className="relative group">
        ...
        <div className="relative bg-black lg:min-w-[566px] px-8 py-6 rounded-lg border border-gray-800 shadow-lg">
          <div className="flex flex-col items-center gap-4">
            <h1 className="text-4xl font-bold">
              {type == "sign-in" ? (
                <div className="flex items-center gap-2">
